...
public class BlogPostDAO {
    ...
    public List<Document> findByDateDescending ( int limit ) {
        ...
        posts = postsCollection.find ().sort ( new Document ( "date", -1 ) ).limit ( limit ).into ( new ArrayList
                <Document> () );
    ...
    public void addPostComment (
            final String name, final String email, final String body,
        ...
        postsCollection.updateOne ( post, Updates.push ( "comments", comment ) );
    }
}
